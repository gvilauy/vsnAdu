    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.openup.aduana.crt.conexion.produccion.WsImagen.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.openup.aduana.crt.conexion.produccion.WsImagen.class.getResource(".");
